...
# ---------- Helper function (must be before any usage) ----------
...
if theme == "dark":
    ...
    <style>
        ...
        @keyframes titleGlow {
            from { text-shadow: 0 0 30px rgba(0, 255, 100, 0.6); }
            to { text-shadow: 0 0 60px rgba(0, 255, 100, 0.9), 0 0 100px rgba(0, 255, 100, 0.5); }
        }
        .subtitle { text-align: center; font-size: 1.1rem; color: #66ff99; margin-bottom: 2rem; position: relative; z-index: 1; }
        .stFileUploader > div {
            background: rgba(0, 255, 100, 0.03) !important; backdrop-filter: blur(15px) !important;
            border: 2px dashed rgba(0, 255, 100, 0.3) !important; border-radius: 20px !important;
            padding: 2rem !important; transition: all 0.3s ease; position: relative; z-index: 1;
        }
        ...
        .result-card {
            ...
            padding: 1.5rem; margin: 0.8rem 0; position: relative; overflow: hidden;
        }
        .result-card::before {
        ...
        .action-box {
            background: rgba(0, 255, 100, 0.05); border: 1px solid rgba(0, 255, 100, 0.3);
    ...
    <style>
        ...
        .stFileUploader > div {
            ...
            border: 2px dashed rgba(46,125,50,0.3) !important; border-radius: 20px !important;
        ...
        .scanlines, .particle { display: none; }
    </style>
    """, unsafe_allow_html=True)
