...
CHECKPOINT_MAP = {
    ...
    "apple": os.path.join("models", "apple", "model.pt"),
    "cassava": os.path.join("models", "cassava", "model.pt"),
    "coffee": os.path.join("models", "coffee", "model.pt"),
    "grape": os.path.join("models", "grape", "model.pt"),
    "sugarcane": os.path.join("models", "sugarcane", "model.pt"),
    "tea": os.path.join("models", "tea", "model.pt"),
}
...
if crop is None:
    cols = st.columns(4)  # 4 columns for 12 crops
    crop_names = list(CROP_CLASSES.keys())
