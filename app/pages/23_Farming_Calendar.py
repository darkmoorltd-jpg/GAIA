...
st.markdown('<div class="subtitle">Your personalized season‑long action plan — generated by DeepSeek AI</div>', unsafe_allow_html=True)
...
if st.button("Generate My Calendar", type="primary"):
    ...
    with st.spinner("🧠 DeepSeek is generating your personalized farming calendar..."):
        # Try DeepSeek first
        activities = generate_calendar_with_deepseek(crop, planting_date.isoformat(), location)

        if activities is None:
            # Fallback to templates
            st.warning("DeepSeek unavailable — using standard template.")
