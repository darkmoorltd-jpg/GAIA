...
st.markdown(
    "<h1 style='color:#2e7d32;'>🏦 Loan Management</h1>", unsafe_allow_html=True
)
    ...
    with st.form("loan_form"):
        ...
        with col2:
            ...
            interest_rate = st.number_input(
                "Interest Rate (% annual)", min_value=0.0, max_value=30.0, value=12.0
            )
...
with tab2:
    ...
    if loans:
        ...
        total_disbursed = (
            df[df["status"] == "approved"]["loan_amount"].astype(float).sum()
        )
