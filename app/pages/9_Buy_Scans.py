...
if st.session_state.chosen_plan:
    ...
    scans_display = "Unlimited" if st.session_state.chosen_plan == "unlimited" else f"{plan_data['scans']} scans"
    ...
    # SIMPLE PAYSTACK BUTTON - opens full screen popup natively
    paystack_js = f"""
    ...
    """
    components.html(paystack_js, height=120)
