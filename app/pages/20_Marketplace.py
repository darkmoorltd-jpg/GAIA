...
with tab2:
    ...
    with st.form("sell_produce_form"):
        ...
        with col1:
            ...
            variety = st.text_input("🧬 Variety (optional)", placeholder="e.g., SAMMAZ 15")
